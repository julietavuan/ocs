...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="label"><label for="issue">{translate key="issue.issue"}</label></td>
		<td class="value">
		
			<select name="issue" id="depositPoint-{$depositPointKey|escape}-depositPoint" class="selectMenu">
					<option value=""> </option>
					{html_options options=$allIssues selected=$issue}
			</select>
...
{else}
	<tr>
		...
		<td colspan="3" align="right">{page_links anchor="articles" name="articles" iterator=$articles swordUrl=$depositPoint.url depositPoint=0}</td>
	</tr>
{/if}
</table>
